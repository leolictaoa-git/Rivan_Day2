...
conf t
 ...
 int gi0/1
  ...
  exit
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.41.41.1 120
 enable secret pass
 line vty 0 14
  password pass
  transport input all
...
conf t
 int fa0/0
  ...
  exit
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.41.100.4 120
 enable secret pass
 line vty 0 14
  password pass
  transport input all
...
conf t
 int gi 0/0/0
  ...
  exit
 ip routing
 ip route 10.41.0.0 255.255.0.0 10.41.41.4 120
 enable secret pass
 line vty 0 14
  password pass
  transport input all
...
| Description                      | Command                                  |
| ---                              | ---                                      |
| a non-default hostname           | hostname coreBaba41                  |
...
~~~
!@NetOps
ansible-playbook -i rivan_mkt.ini playbooks/deploy_41.yml --skip-tags ivrs
~~~
